CREATE SCHEMA domain_team_2_ddos_data;

USE domain_team_2_ddos_data;

CREATE TABLE Fingerprint ( 
  fingerprint_id VARCHAR(255) PRIMARY KEY NOT NULL, 
  target VARCHAR(255),
  location VARCHAR(155),
  domain_team INT DEFAULT 2
);
...
GRANT CREATE, ALTER, DROP, INSERT, UPDATE, DELETE, SELECT, REFERENCES, RELOAD on *.* TO 'user2'@'%' WITH GRANT OPTION;
